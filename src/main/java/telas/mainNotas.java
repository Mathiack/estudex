...
public class mainNotas extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mainNotas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
